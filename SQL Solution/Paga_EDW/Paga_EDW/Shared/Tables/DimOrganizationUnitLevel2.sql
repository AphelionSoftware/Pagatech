CREATE TABLE [Shared].[DimOrganizationUnitLevel2] (
	...
	CONSTRAINT [fk_DimOrganizationUnitLevel2_DimOrganizationUnitUserID] FOREIGN KEY ([DimOrganizationUnitUserID]) REFERENCES [Shared].[DimUser] ([DimUserID])
);
...
GO
EXECUTE sp_addextendedproperty @name = N'SCDType', @value = N'2', @level0type = N'SCHEMA', @level0name = N'Shared', @level1type = N'TABLE', @level1name = N'DimOrganizationUnitLevel2', @level2type = N'COLUMN', @level2name = N'Code';
...
GO
EXECUTE sp_addextendedproperty @name = N'DisplayName', @value = N'DimOrganizationID', @level0type = N'SCHEMA', @level0name = N'Shared', @level1type = N'TABLE', @level1name = N'DimOrganizationUnitLevel2', @level2type = N'COLUMN', @level2name = N'DimOrganizationID';
