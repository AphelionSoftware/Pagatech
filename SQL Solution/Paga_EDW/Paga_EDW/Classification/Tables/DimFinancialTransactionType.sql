CREATE TABLE [Classification].[DimFinancialTransactionType] (
    ...
    CONSTRAINT [uc_DimFinancialTransactionType_SourceKey] UNIQUE NONCLUSTERED ([SourceKey] ASC)
);
...
GO
EXECUTE sp_addextendedproperty @name = N'SCDType', @value = N'2', @level0type = N'SCHEMA', @level0name = N'Classification', @level1type = N'TABLE', @level1name = N'DimFinancialTransactionType', @level2type = N'COLUMN', @level2name = N'Code';
