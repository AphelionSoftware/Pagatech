CREATE TABLE [dbo].[Dim_Currency] (
    ...
    CONSTRAINT [pk_DimCurrency] PRIMARY KEY CLUSTERED ([DimCurrencyID] ASC)
);
...
GO
EXECUTE sp_addextendedproperty @name = N'LoadGroup', @value = N'1', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Dim_Currency';
