CREATE TABLE [Mapping].[PaymentUseCaseToTxTypeMap] (
    ...
    CONSTRAINT [FK_PaymentUseCaseToTxTypeMap_DimFinancialTxTypeID] FOREIGN KEY ([DimFinancialTxTypeID]) REFERENCES [Finance].[DimFinancialTransactionType] ([DimFinancialTxTypeID]),
