CREATE TABLE [Shared].[DimDate] (
    ...
    PRIMARY KEY CLUSTERED ([DimDateID] ASC)
);


GO
EXECUTE sp_addextendedproperty @name = N'LoadGroup', @value = N'1', @level0type = N'SCHEMA', @level0name = N'Shared', @level1type = N'TABLE', @level1name = N'DimDate';
