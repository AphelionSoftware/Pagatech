...
EXECUTE sp_addextendedproperty @name = N'BaseQuery', @value = N'
		...
		FROM CHANGETABLE(CHANGES [dbo].[FinancialAccountType] ', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'FinancialAccountType';
...
CREATE UNIQUE CLUSTERED INDEX [ix_FinancialAccountType]
    ON [dbo].[FinancialAccountType]([as_of_change_version] ASC, [SYS_CHANGE_OPERATION] ASC, [FinancialAccountTypeId] ASC, [row_id] ASC) WITH (DATA_COMPRESSION = PAGE);
