...
EXECUTE sp_addextendedproperty @name = N'BaseQuery', @value = N'
		...
		FROM CHANGETABLE(CHANGES [dbo].[OrganizationUnitType] ', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'OrganizationUnitType';
...
CREATE UNIQUE CLUSTERED INDEX [ix_OrganizationUnitType]
    ON [dbo].[OrganizationUnitType]([as_of_change_version] ASC, [SYS_CHANGE_OPERATION] ASC, [OrganizationUnitTypeId] ASC, [row_id] ASC) WITH (DATA_COMPRESSION = PAGE);
