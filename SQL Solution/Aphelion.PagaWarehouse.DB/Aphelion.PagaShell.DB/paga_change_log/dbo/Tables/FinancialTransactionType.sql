...
EXECUTE sp_addextendedproperty @name = N'BaseQuery', @value = N'
		...
		FROM CHANGETABLE(CHANGES [dbo].[FinancialTransactionType] ', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'FinancialTransactionType';
...
CREATE UNIQUE CLUSTERED INDEX [ix_FinancialTransactionType]
    ON [dbo].[FinancialTransactionType]([as_of_change_version] ASC, [SYS_CHANGE_OPERATION] ASC, [FinancialTransactionTypeId] ASC, [row_id] ASC) WITH (DATA_COMPRESSION = PAGE);
