CREATE TABLE [Import].[FileSection] (
    ...
    [StartRowID]         INT           CONSTRAINT [DF__FileSecti__Start__693CA210] DEFAULT ((0)) NOT NULL,
    [StartColumnID]      INT           CONSTRAINT [DF__FileSecti__Start__6A30C649] DEFAULT ((0)) NOT NULL,
    [EndRowID]           INT           NULL,
