CREATE TABLE [Admin].[ReconProcessStep] (
    ...
    [CurrentSourceImportedFileID] INT           NULL,
    [CurrentTargetImportedFileID] INT           NULL,
    ...
    CONSTRAINT [FK_ReconProcessStep_ImportedFile] FOREIGN KEY ([CurrentSourceImportedFileID]) REFERENCES [Recon].[ImportedFile] ([ID]),
    CONSTRAINT [FK_ReconProcessStep_ImportedFile1] FOREIGN KEY ([CurrentTargetImportedFileID]) REFERENCES [Recon].[ImportedFile] ([ID]),
