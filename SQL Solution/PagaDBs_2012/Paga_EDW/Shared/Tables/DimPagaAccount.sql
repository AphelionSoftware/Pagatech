CREATE TABLE [Shared].[DimPagaAccount] (
    ...
    [IsActive]               BIT           NULL,
    [IsEnabled]              BIT           NULL,
    [affiliate]              BIT SPARSE    NULL,
    [agent]                  BIT SPARSE    NULL,
    [bank]                   BIT SPARSE    NULL,
    [business]               BIT SPARSE    NULL,
    [card_processor]         BIT SPARSE    NULL,
    [cash_collector]         BIT SPARSE    NULL,
    [customer]               BIT SPARSE    NULL,
    [merchant]               BIT SPARSE    NULL,
    [mobile_operator]        BIT SPARSE    NULL,
    [paga]                   BIT SPARSE    NULL,
    [remittance_processor]   BIT SPARSE    NULL,
    [service_aggregator]     BIT SPARSE    NULL,
