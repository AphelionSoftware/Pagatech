/****** Object:  Database Paga_EDW    Script Date: 8/26/2014 6:18:37 PM ******/
...
CREATE TABLE	[Shared].[DimDate]
	(	[DimDateID] INT NOT NULL, 
		...
		[IsHolidayNG] BIT Null,-- Flag 1=National Holiday, 0-No National Holiday
		[HolidayNG] VARCHAR(50) Null, --Name of Holiday in UK
		sys_ModifiedBy VARCHAR(255) NOT NULL DEFAULT SYSTEM_USER,
		sys_ModifiedOn DATETIME NOT NULL DEFAULT GETDATE(),
		sys_CreatedBy VARCHAR(255) NOT NULL DEFAULT SYSTEM_USER,
...
DECLARE @sql AS NVARCHAR(200) = N'CREATE SCHEMA Classification';
IF SCHEMA_ID('Classification')IS NULL
EXEC sp_executesql @sql;
GO


/* Drop table DimStatusCancellationApprovalStatus */
IF OBJECT_ID('Classification.DimStatusCancellationApprovalStatus') IS NOT NULL
DROP TABLE Classification.DimStatusCancellationApprovalStatus;
GO


/* Create table Classification.DimStatusCancellationApprovalStatus */
CREATE TABLE Classification.DimStatusCancellationApprovalStatus
(
...
ALTER TABLE Classification.DimStatusCancellationApprovalStatus
...
ON Classification.DimStatusCancellationApprovalStatus
(
    SourceKey
);
GO
...
IF OBJECT_ID('Classification.DimPagaAccountStatus') IS NOT NULL
DROP TABLE Classification.DimPagaAccountStatus;
GO
...
ALTER TABLE Classification.DimPagaAccountStatus
...
ON Classification.DimPagaAccountStatus
(
    SourceKey
);
GO
...
IF OBJECT_ID('Classification.DimProcessStatus') IS NOT NULL
DROP TABLE Classification.DimProcessStatus;
GO
...
ALTER TABLE Classification.DimProcessStatus
...
ON Classification.DimProcessStatus
(
    SourceKey
);
GO
...
IF OBJECT_ID('Classification.DimProcessType') IS NOT NULL
DROP TABLE Classification.DimProcessType;
GO
...
ALTER TABLE Classification.DimProcessType
...
ON Classification.DimProcessType
(
    SourceKey
);
GO
...
IF OBJECT_ID('Classification.DimFinancialTransactionType') IS NOT NULL
DROP TABLE Classification.DimFinancialTransactionType;
GO
...
ALTER TABLE Classification.DimFinancialTransactionType
...
ON Classification.DimFinancialTransactionType
(
    SourceKey
);
GO
...
IF OBJECT_ID('Classification.DimAgentCommissionType') IS NOT NULL
DROP TABLE Classification.DimAgentCommissionType;
GO
...
ALTER TABLE Classification.DimAgentCommissionType
...
ON Classification.DimAgentCommissionType
(
    SourceKey
);
GO
...
IF OBJECT_ID('Classification.DimBankAccountLinkStatus') IS NOT NULL
DROP TABLE Classification.DimBankAccountLinkStatus;
GO


/* Create table Classification.DimBankAccountLinkStatus */
CREATE TABLE Classification.DimBankAccountLinkStatus
(
...
ALTER TABLE Classification.DimBankAccountLinkStatus
...
ON Classification.DimBankAccountLinkStatus
(
    SourceKey
);
GO
...
IF OBJECT_ID('Classification.DimOrganizationSubscriptionStatus') IS NOT NULL
DROP TABLE Classification.DimOrganizationSubscriptionStatus;
GO
...
ALTER TABLE Classification.DimOrganizationSubscriptionStatus
...
ON Classification.DimOrganizationSubscriptionStatus
(
    SourceKey
);
GO
...
IF OBJECT_ID('Classification.DimOrganizationVerificationStatus') IS NOT NULL
DROP TABLE Classification.DimOrganizationVerificationStatus;
GO
...
ALTER TABLE Classification.DimOrganizationVerificationStatus
...
ON Classification.DimOrganizationVerificationStatus
(
    SourceKey
);
GO
...
IF OBJECT_ID('Finance.DimCOALevel1') IS NOT NULL
DROP TABLE Finance.DimCOALevel1;
GO


/* Create table Finance.DimCOALevel1 */
CREATE TABLE Finance.DimCOALevel1
(
...
ALTER TABLE Finance.DimCOALevel1
...
IF OBJECT_ID('Finance.DimCOALevel2') IS NOT NULL
DROP TABLE Finance.DimCOALevel2;
GO
...
ALTER TABLE Finance.DimCOALevel2
...
IF OBJECT_ID('Finance.DimCOALevel3') IS NOT NULL
DROP TABLE Finance.DimCOALevel3;
GO
...
ALTER TABLE Finance.DimCOALevel3
...
IF OBJECT_ID('Finance.DimCOALevel4') IS NOT NULL
DROP TABLE Finance.DimCOALevel4;
GO
...
ALTER TABLE Finance.DimCOALevel4
...
IF OBJECT_ID('Finance.DimFinancialAccount') IS NOT NULL
DROP TABLE Finance.DimFinancialAccount;
GO
...
ALTER TABLE Finance.DimFinancialAccount
...
ON Finance.DimFinancialAccount
(
    SourceKey
);
GO
...
IF OBJECT_ID('Activity.DimChannel') IS NOT NULL
DROP TABLE Activity.DimChannel;
GO
...
ALTER TABLE Activity.DimChannel
...
DECLARE @sql AS NVARCHAR(200) = N'CREATE SCHEMA Location';
...
IF OBJECT_ID('Location.DimCountry') IS NOT NULL
DROP TABLE Location.DimCountry;
GO
...
ALTER TABLE Location.DimCountry
...
IF OBJECT_ID('Location.DimGeoZone') IS NOT NULL
DROP TABLE Location.DimGeoZone;
GO
...
ALTER TABLE Location.DimGeoZone
...
IF OBJECT_ID('Location.DimRegion') IS NOT NULL
DROP TABLE Location.DimRegion;
GO
...
ALTER TABLE Location.DimRegion
...
IF OBJECT_ID('Location.DimGovernmentLocalArea') IS NOT NULL
DROP TABLE Location.DimGovernmentLocalArea;
GO
...
ALTER TABLE Location.DimGovernmentLocalArea
...
ON Location.DimGovernmentLocalArea
(
    SourceKey
);
GO
...
/* Drop table DimCity */
IF OBJECT_ID('Location.DimCity') IS NOT NULL
DROP TABLE Location.DimCity;
GO
...
IF OBJECT_ID('Airtime.DimMobileOperator') IS NOT NULL
DROP TABLE Airtime.DimMobileOperator;
GO
...
ALTER TABLE Airtime.DimMobileOperator
