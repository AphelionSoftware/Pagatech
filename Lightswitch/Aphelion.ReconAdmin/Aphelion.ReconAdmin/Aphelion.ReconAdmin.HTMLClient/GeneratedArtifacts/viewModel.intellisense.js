...
(function (lightSwitchApplication) {
    ...
    msls._addEntryPoints(lightSwitchApplication.AddEditFileDefinition, {
        ...
        /// <field>
        /// Called after the ReconSourceID content item has been rendered.
        /// <br/>postRender(HTMLElement element, msls.ContentItem contentItem)
        /// </field>
        ReconSourceID_postRender: [$element, function () { return new lightSwitchApplication.AddEditFileDefinition().findContentItem("ReconSourceID"); }],
        /// <field>
    ...
    msls._addEntryPoints(lightSwitchApplication.ViewFileDefinition, {
        ...
        /// <br/>postRender(HTMLElement element, msls.ContentItem contentItem)
        /// </field>
        ReconSourceID_postRender: [$element, function () { return new lightSwitchApplication.ViewFileDefinition().findContentItem("ReconSourceID"); }],
        /// <field>
        /// Called after the FileType content item has been rendered.
        /// <br/>postRender(HTMLElement element, msls.ContentItem contentItem)
        /// </field>
    ...
    msls._addEntryPoints(lightSwitchApplication.BrowseFileDefinitions, {
        ...
        /// <br/>postRender(HTMLElement element, msls.ContentItem contentItem)
        /// </field>
        ReconSourceID_postRender: [$element, function () { return new lightSwitchApplication.BrowseFileDefinitions().findContentItem("ReconSourceID"); }]
    });
